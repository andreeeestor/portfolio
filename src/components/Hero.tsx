  ...
  return (
    <section>
      <section className="w-full h-[75vh]">
        <h1 className="text-8xl font-medium font-sequel uppercase relative flex flex-col">
          <div className="flex items-center">
            ...
            <svg
              ...
              className="animate-spin absolute left-[486px] top-[9.5px]"
            >
              {" "}
      ...
      <section className="animate-bounce flex justify-center items-center">
        <div className=" text-5xl -rotate-90 pb-3 pt-2 px-3 rounded-full shadow-md bg-black text-[#ACAAFF]">
          ⇜
        </div>
      </section>
    </section>
